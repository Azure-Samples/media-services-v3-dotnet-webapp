...
param noEncryptionStreamingPolicyName string = 'VideosSampleNoEncryptionStreamingPolicy'
...
// Create a Streaming Policy to allow streaming without encryption.
resource noEncryptionStreamingPolicy 'Microsoft.Media/mediaServices/streamingPolicies@2021-11-01' = {
  name: '${mediaServicesAccount.name}/${noEncryptionStreamingPolicyName}'
  properties: {
    noEncryption: {
      enabledProtocols: {
        dash: true
